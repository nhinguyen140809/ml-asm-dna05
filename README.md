...
Bài tập lớn sử dụng bộ dữ liệu `subjects-questions.csv` dạng bảng với 121.679 mẫu, chứa các câu hỏi do học sinh đặt ra trong quá trình chuẩn bị các kỳ thi JEE Advanced, JEE Mains, NEET, AIMs. Mỗi câu hỏi được gán nhãn môn học tương ứng: `Physics`, `Chemistry`, `Biology`, hoặc `Mathematics`. 
